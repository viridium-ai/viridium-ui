...
export class InventoryConfigApp extends HomeApp {
  ...
  public routeItems: Array<RouteItem> = [
    new RouteItem().init("Value Chain", "Value Chain Config", "2", "/inventory-app/value-chain-config"),
    new RouteItem().init("Inventory", "Inventory Config", "2", "/inventory-app"),
  ...
  public getRoutes = () => {
    return (
      <>
        ...
        <Route path="/inventory-app/sources" element={<DataSources next={'/inventory-app/questionnaires'} prev='/inventory-app/items' />} />
        <Route path="/inventory-app/questionnaires" element={<Questionnaires prev='/inventory-app/sources'/>} />
        <Route path="/inventory-app/help" element={<Help />} />
        <Route path="/inventory-app/value-chain-config" element={<ValueChainConfig />} />
      </>
    );
  }
}
